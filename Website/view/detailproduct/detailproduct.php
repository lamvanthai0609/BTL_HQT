...
<body>
	...
	<?php require('website/controllers/detailproduct/detailproduct.php'); ?>
		...
		<div class="row" style="width: 100%;">
			...
			<div class="col-5">
				...
				<div>
					...
					<i onclick="sao1(<?php if($id !="" && isset($data_commentcheck)){ echo $id;}else{echo "'chualogin '";} ?>,<?php echo $idsp; ?>)" id="sao1" style="font-size: 30px;<?php if($datavote['vote'] >=1){ echo "color: #ffc312"; } ?>" class="fas fa-star"></i>
					<i onclick="sao2(<?php if($id !="" && isset($data_commentcheck)){ echo $id;}else{echo "'chualogin'";} ?>,<?php echo $idsp; ?>)" id="sao2" style="font-size: 30px;<?php if($datavote['vote'] >=2){ echo "color: #ffc312"; } ?>" class="fas fa-star"></i>
					<i onclick="sao3(<?php if($id !="" && isset($data_commentcheck)){ echo $id;}else{echo "'chualogin '";} ?>,<?php echo $idsp; ?>)" id="sao3" style="font-size: 30px;<?php if($datavote['vote'] >=3){ echo "color: #ffc312"; } ?>" class="fas fa-star"></i>
					<i onclick="sao4(<?php if($id !="" && isset($data_commentcheck)){ echo $id;}else{echo "'chualogin '";} ?>,<?php echo $idsp; ?>)" id="sao4" style="font-size: 30px;<?php if($datavote['vote'] >=4){ echo "color: #ffc312"; } ?>" class="fas fa-star"></i>
					<i onclick="sao5(<?php if($id !="" && isset($data_commentcheck)){ echo $id;}else{echo "'chualogin '";} ?>,<?php echo $idsp; ?>)" id="sao5" style="font-size: 30px;<?php if($datavote['vote'] >=5){ echo "color: #ffc312"; } ?>" class="fas fa-star"></i>
				</div>
			</div>
		</div>
	</div>
