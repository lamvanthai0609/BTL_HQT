				...
				<!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
						<div class="signup" id="dangky" style="display: none;transition: 1s;animation: moveBottom 1s ease-out;">
							...
							<div class="input-group form-group" style="width: 65px;margin-right: -10px;">
									<input type="button" onclick="" value="Send" class="btn float-right login_btn">
							</div>
							<!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
							...
							<div class="input-group form-group singup" id="singup6" style="width: 145px;">
								...
								<input name="verify" type="text"  class="form-control" placeholder="MXM">								
							</div>
							<!--aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa-->
						</div>
						...
						<div class="form-group">
							...
							<p style="margin-top: 10px; font-size: 15px;"><?php if(isset($erro)){echo '<i style="margin-right: 5px;color: #ff0000" class="fas fa-user-times"></i>'.$erro;} ?></p>
						</div>
					</form>
				</div>
